@php
    ...
    $listSchema = [
        ...
        '@type' => 'ItemList',
        'name' => $activeService ? $activeService->title . ' projects' : 'Case studies',
...
>
    @push('heads')
        <script type="application/ld+json">
            {!! json_encode($listSchema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_HEX_TAG) !!}
        </script>
    @endpush

    <div class="bg-surface text-on-surface flex w-full flex-col">
        <section class="w-full border-b border-[#E1E5EA] pt-8 pb-8 md:pt-12 md:pb-10 lg:pt-16 lg:pb-12">
            <div class="site-container">
                <div class="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
                    <div class="max-w-3xl">
                        ...
                        <h1
                            class="font-display text-[36px] leading-[1.05] font-semibold tracking-[-0.04em] text-[#0A0A0A] sm:text-[52px] lg:text-[56px] xl:text-[64px]"
                        >
                ...
                @if ($services->isNotEmpty())
                    <nav class="mt-8 flex gap-1.5 overflow-x-auto border-t border-[#E1E5EA] pt-4 lg:mt-10" aria-label="Filter projects by service">
                        <a
